...
namespace WindowsFormsApp
{
    public partial class MainWindow : System.Windows.Forms.Form
    {
        ...
        private void listBoxCategories_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (this.listBoxCategories.Items.Count == 0 || listBoxSnippets.Items.Count == 0)
            {
        ...
        private static void SetTabWidth(RichTextBox textbox, int tabWidth)
        {
            ...
            int characterWidth = (int)graphics.MeasureString("M", textbox.Font).Width;
        ...
        {
            String message = $"Osm{Environment.NewLine}Other Snippet Manager{Environment.NewLine}Version: {_Version}{Environment.NewLine}Release Date: {_ReleaseDate}{Environment.NewLine}Developer: PlainOldProgrammer";
